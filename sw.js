...
const SHELL = 'nyc-shell-v2';   // fichiers de l'app
const RUN   = 'nyc-run-v2';     // Leaflet + tuiles, mis en cache à l'usage
...
self.addEventListener('fetch', e => {
  ...
  const isTile = /basemaps\.cartocdn\.com|tile\.openstreetmap\.org|upload\.wikimedia\.org|en\.wikipedia\.org/.test(url.hostname);
